...
const char* ts3plugin_description() {
    /* If you want to use wchar_t, see ts3plugin_name() on how to use */
    return "This plugin enables automatic channel moving for simulator pilots as they tune their simulated COM1 radio.";
}
...
/// Anything below here is sample code ///
    ...
    //{  /* connection established and we have client and channels available */
    //    char* s;
    //    char msg[1024];
    //    anyID myID;
    //    uint64* ids;
