...
public:
    ...
    uint64 getChannelID(uint16_t frequency, uint64 current = 0, uint64 root = 0, double lat = -999.9, double lon = -999.0);
    uint64 getChannelID(double frequency, uint64 current = 0, uint64 root = 0, double lat = -999.9, double lon = -999.0);
